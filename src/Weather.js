...
const Weather = ({ weatherData }) => {
  ...
  return (
    <div>
      {weatherData.list ? (
        <div className="bg-white bg-opacity-20 w-[580px] h-[500px] rounded-md m-auto">
          ...
          <div className="element flex justify-between text-white mx-20 my-10">
          ...
          {/* 3 Günlük Tahmin */}
          <div className="bg-white bg-opacity-20 w-[580px] h-[265px] rounded-md flex m-auto">
